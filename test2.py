...
gmail_user = 'itgeekitrix@gmail.com'
gmail_pwd = 'dyqnsptgsufieldl'
FROM = 'itgeekitrix@gmail.com'
TO = ['kmndharshini@gmail.com']  # must be a list
...
def mail():
    ...
    # DO THE CHANGES HERE
    body = "THIS IS  your otp for logging into e-ATM :" + str(otp_)
